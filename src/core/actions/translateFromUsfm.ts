// import { TString, TStrings } from "./TString";
...
// export default function testTranslateFromUsfm(
//   tStrings: TStrings,
//   usfm: string,
//   opts = DEFAULT_OPTS
// ): { translations: Translations; errors: string[] } {
//   const usfmBook = usfmParseBook(usfm);
//   const mtBookName = usfmParseLocalBookName(usfm);
//   const errors: string[] = [];
//   const translations = tStrings.reduce(
//     (translations: Translations, tString) => {
//       try {
//         if (tString.targetText.length > 0 && !opts.overwrite)
//           return translations;
//         if (!tString.mtString) return translations;
...
//         return { ...translations, [`${tString.id}`]: passageTextWithRef };
//       } catch (err) {
