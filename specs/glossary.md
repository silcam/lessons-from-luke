...
**Assembled quarter book** (noun): The deliverable of the assembled-quarter-download feature — a single, self-contained, fully editable document for one (Language, Book, Quarter, Assembly mode) consisting of the Table of Contents followed by lessons 1–13 in order, with per-lesson first-page number suppression. Numbered in two sequences: a roman-numeral Front-matter sequence and an arabic Body sequence restarting at `1` on the first lesson. (Feature 007 originally specified one continuous sequence matched to the reference deliverable; superseded by 017 after client feedback 2026-08-11.) [Docs: specs/007-assembled-quarter-download/spec.md, specs/017-quarter-pagination-fixes/spec.md] [See: Quarter, Assembly job, Assembly mode, TOC lesson, Front-matter sequence, Body sequence]
...
**Blank filler page** (noun): A contentless, unnumbered page inserted before the first lesson of an Assembled quarter book only when needed to place that lesson recto. Belongs to the Front-matter sequence and consumes one number in it. [Docs: specs/017-quarter-pagination-fixes/spec.md] [See: Front-matter sequence, Recto, Assembled quarter book]

**Body sequence** (noun): The arabic-numbered run of pages in an Assembled quarter book, from the first page of the first lesson to the end of the book. Begins at `1`, runs continuously across all lessons, and suppresses (but still counts) each lesson's first page. [Docs: specs/017-quarter-pagination-fixes/spec.md] [See: Front-matter sequence, Assembled quarter book]
...
**Coloring page** (noun): A lesson page laid out as two identical half-sheets, each carrying a truth line, an inline graphic, and the lesson's Memory verse. The repetition is intentional (two copies per printed sheet), so both halves must render identically. [Docs: specs/017-quarter-pagination-fixes/spec.md] [See: Memory verse, Assembled quarter book]
...
**Front-matter sequence** (noun): The lowercase-roman-numbered run of pages in an Assembled quarter book, from the first page up to and including any Blank filler page. Begins at `i`, which prints no number. [Docs: specs/017-quarter-pagination-fixes/spec.md] [See: Body sequence, Blank filler page, TOC lesson]
...
**Memory verse** (noun): The scripture verse a lesson teaches for memorization. On a Coloring page it appears **twice by design** — once per printed half-sheet — and both copies carry the memory-verse paragraph style. The style is named in two families across the corpus (`M.T. Coloring Page - Memory Verse` and the plain `Coloring Page - Memory Verse`) and is often reached indirectly through an automatic style's parent. Neither copy is a duplicate to be removed. [Docs: specs/017-quarter-pagination-fixes/spec.md] [See: M.T. styles, Assembled quarter book]
...
**Recto** (noun): A right-hand page in a duplex-printed book — an odd physical page position, counting the first page as 1. Its opposite is a **verso** (left-hand, even) page. The first lesson of an Assembled quarter book must open recto. [Docs: specs/017-quarter-pagination-fixes/spec.md] [See: Blank filler page, Assembled quarter book]
